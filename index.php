...
if (isset($_POST['action'])) {
  switch($_POST['action']) {
    ...
    case 'toggle':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $updateQuery = 'UPDATE `table` SET `my_bool` = NOT my_bool'; // IMPLEMENT ME
    ...
    case 'delete':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $deleteQuery = "DELETE FROM tasks WHERE id =".$id // IMPLEMENT ME
 ...
 */
$selectQuery = 'SELECT * FROM todo'; // IMPLEMENT ME (IMPLEMENT DONE)
